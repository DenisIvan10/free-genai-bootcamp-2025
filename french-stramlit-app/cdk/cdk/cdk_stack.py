...
import aws_cdk as core # type: ignore
...
class CdkStack(core.Stack):
    def __init__(self, scope, id: str, **kwargs) -> None:
        ...
        # Create a VPC
        vpc = ec2.Vpc(self, "StreamlitFrenchVPC", max_azs=2)

        # Create ECS cluster
        cluster = ecs.Cluster(self, "StreamlitFrenchCluster", vpc=vpc)
