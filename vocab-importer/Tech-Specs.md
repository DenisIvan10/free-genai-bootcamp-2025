...
Fetch from the GET localhost:5000/api/groups/:id/raw, this will return a collection of words in a json structure. It will have french words with their english translation. We need to store this collection of words in memory
...
- simple objects eg. book, car, croissant, café
