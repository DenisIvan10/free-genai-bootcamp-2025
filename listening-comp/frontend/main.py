...
def render_interactive_stage():
    ...
    if 'question_generator' not in st.session_state:
        st.session_state.question_generator = QuestionGenerator(api_key="your_mistral_api_key")
    if 'audio_generator' not in st.session_state:
        st.session_state.audio_generator = AudioGenerator(api_key="your_mistral_api_key")
